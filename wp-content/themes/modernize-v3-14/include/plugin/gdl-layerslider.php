...
$layerslider = get_stylesheet_directory() . '/include/plugin/layerslider/layerslider.php';
...
function my_layerslider_overrides() {
	...
	// Items to override
	$GLOBALS['lsPluginPath'] = get_stylesheet_directory_uri() . '/include/plugin/layerslider/';
