...
<div id="caro-wrapper" class="col-md-6 vcenter">
										<div class="ism-slider" id="my-slider">
  <ol>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447661908_206297.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447689140_74709.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447740156_348619.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447758756_71262.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447777524_709988.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447798021_531522.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447846322_336709.jpg">
    </li>
    <li>
      <img src="http://localhost:81/evoDev\wp-content\themes\hestia\inc\sections\carosel-imgs\1529447881244_904153.jpg">
    </li>
  </ol>
</div>
</div><?php hestia_show_big_title_content( $section_content ); ?> <!--NOTE THAT SPACING OF HTML MATTERS HERE, USING A HACK WITH THE VCENTER -->
									</div>
...
function hestia_show_big_title_content( $content ) {
	?><div class="col-md-6 text-center vcenter"> <!--NOTE THAT SPACING OF HTML MATTERS HERE, USING A HACK WITH THE VCENTER -->
